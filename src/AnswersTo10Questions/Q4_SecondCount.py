...
output_filename = "sec_2018-03-12.log"
output_error = "sec_2018-03-12_error.log"


def get_secondData_byHour(filename):
    ...
    with open(filename, 'r') as f:
        for line in f:
            ...
            time_index = int(float(line_list[0]) - time_start)
...
if __name__ == '__main__':
    ...
    for hourly_file in os.listdir(data_folder):
        if "conn." in hourly_file:
            get_secondData_byHour(data_folder+"/"+hourly_file)

    outputF = open(output_folder + "/" + output_filename, 'a')
    outputF.write("# output secondly volume of dns traffic in 2018-03-12. second_index\tin\tout.\n")
